    ...
    grasppe.canvas.Chart.prototype = Object.assign(Object.create((typeof google === 'object' && typeof google.visualization === 'object' && google.visualization.ScatterChart === 'function') ? google.visualization.ScatterChart : Object, {
        ...
        drawOverlay: function (forceRepaint) {
            if ('legend' in this.options) {
                ...
                if (!legendText || legendText === '' || !legendStyles || !legendBoxStyle) return this;
                if (options.current.labels === options.legend.labels.join('|').replace(/\s*/g,'')) return this;
                
                $legend = (this.legend instanceof HTMLElement) ? $(this.legend) : $(this.container).find('.legend-wrapper');
                if ($legend.length === 0) {
                    $legend = $('<div class="legend-wrapper container-fluid md-whiteframe-1dp" style="background-color: ' + legendBoxStyle.fillStyle + '; border: 1px solid ' + legendBoxStyle.strokeStyle + '; position:relative; margin:5px 0.5vmin; width:auto; display: flex; overflow:hidden;"></div>').appendTo(this.container);
                    legendText.forEach(function (text, index) {
                        $legend.append($('<div class="legend-item col-xs-4 legend-item-' + index + '" style="font-size:10pt; padding:0 .25em; display: flex; flex-direction: row; white-space: no-wrap; overflow: hidden; text-overflow:ellipsis;">\
                            <div class="legend-symbol" style="color: ' + legendStyles[index].strokeStyle + '; white-space:nowrap; overflow: hidden; display:block; vertical-align: baseline; height: 100%">\
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="14" height="12" viewBox="0 0 32 32"><path fill="' + legendStyles[index].strokeStyle + '" d="M27.429 3.429v25.143q0 0.464-0.339 0.804t-0.804 0.339h-25.143q-0.464 0-0.804-0.339t-0.339-0.804v-25.143q0-0.464 0.339-0.804t0.804-0.339h25.143q0.464 0 0.804 0.339t0.339 0.804z"></path></svg>\
                            </div>\
