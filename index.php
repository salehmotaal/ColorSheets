...
<html>
  <head>
    ...
    <meta name="description" content="Demonstrate various print-media concepts." />
    <meta name="robots" content="index,follow">
    <!--meta property="fb:app_id" content="" /-->
    <meta property="og:title" content="grasppe ColorSheets (alpha)">
    <meta property="og:type"   content="website" />
    <meta property="og:description" content="Demonstrate various print-media concepts.">
    <!--meta property="og:image" content="http://dapostr.nashatt.com/assets/images/dpa-alert-facebook-265-2.jpg"-->
    <!--meta property="og:url" content="http://dapostr.nashatt.com"-->
    <!--meta name="twitter:card" content="designr::nashatt"-->
    <!--meta name="twitter:title" content="designr::nashatt"-->
    <!--meta name="twitter:url" content="http://dapostr.nashatt.com/"-->
    <!--meta name="twitter:description" content="Designr let's you design awesome images for your posts using easy templates that fit perfectly to your social media needs."-->
    <!--meta name="twitter:image" content="http://dapostr.nashatt.com/assets/images/dpa-alert-facebook-1008-2.jpg"-->

    <link rel="apple-touch-icon" href="images/Grasppe-ColorSheets-Icon-128.png" />
    <link rel="icon" type="image/png" href="images/Grasppe-ColorSheets-Icon-128.png" />
    <!-- iPad retina portrait startup image -->
    <link href="images/Grasppe-ColorSheets/Grasppe-ColorSheets-Start-Images-1536x2008.gif" media="(device-width: 768px) and (device-height: 1024px)
                and (-webkit-device-pixel-ratio: 2)
                and (orientation: portrait)" rel="apple-touch-startup-image"><!-- iPad retina landscape startup image -->
    <link href="images/Grasppe-ColorSheets/Grasppe-ColorSheets-Start-Images-2048x1496.gif" media="(device-width: 768px) and (device-height: 1024px)
                and (-webkit-device-pixel-ratio: 2)
                and (orientation: landscape)" rel="apple-touch-startup-image"><!-- iPad non-retina portrait startup image -->
    <!--link href="images/Grasppe-ColorSheets/Grasppe-ColorSheets-Start-Images-768x1004.gif" media="(device-width: 768px) and (device-height: 1024px)
                and (-webkit-device-pixel-ratio: 1)
                and (orientation: portrait)" rel="apple-touch-startup-image"><!-- iPad non-retina landscape startup image -->
    <!--link href="images/Grasppe-ColorSheets/Grasppe-ColorSheets-Start-Images-748x1024.gif" media="(device-width: 768px) and (device-height: 1024px)
                and (-webkit-device-pixel-ratio: 1)
                and (orientation: landscape)" rel="apple-touch-startup-image"><!-- iPhone 6 Plus portrait startup image -->
    <link href="images/Grasppe-ColorSheets/Grasppe-ColorSheets-Start-Images-1242x2148.gif" media="(device-width: 414px) and (device-height: 736px)
                and (-webkit-device-pixel-ratio: 3)
                and (orientation: portrait)" rel="apple-touch-startup-image"><!-- iPhone 6 Plus landscape startup image -->
    <link href="images/Grasppe-ColorSheets/Grasppe-ColorSheets-Start-Images-2208x1182.gif" media="(device-width: 414px) and (device-height: 736px)
                and (-webkit-device-pixel-ratio: 3)
                and (orientation: landscape)" rel="apple-touch-startup-image"><!-- iPhone 6 startup image -->
    <link href="images/Grasppe-ColorSheets/Grasppe-ColorSheets-Start-Images-750x1294.gif" media="(device-width: 375px) and (device-height: 667px)
                and (-webkit-device-pixel-ratio: 2)" rel="apple-touch-startup-image"><!-- iPhone 5 startup image -->
    <link href="images/Grasppe-ColorSheets/Grasppe-ColorSheets-Start-Images-640x1096.gif" media="(device-width: 320px) and (device-height: 568px)
                and (-webkit-device-pixel-ratio: 2)" rel="apple-touch-startup-image"><!-- iPhone < 5 retina startup image -->
    <link href="images/Grasppe-ColorSheets/Grasppe-ColorSheets-Start-Images-640x920.gif" media="(device-width: 320px) and (device-height: 480px)
                and (-webkit-device-pixel-ratio: 2)" rel="apple-touch-startup-image"><!-- iPhone < 5 non-retina startup image -->
    <link href="//placehold.it/320x460.gif" media="(device-width: 320px) and (device-height: 480px)
                and (-webkit-device-pixel-ratio: 1)" rel="apple-touch-startup-image">

    <meta name="apple-mobile-web-app-capable" content="yes" />
    <meta name="apple-mobile-web-app-status-bar-style" content="black" />

    <title>ColorSheets</title>
    ...
    <link rel="stylesheet" href="stylesheets/colorsheets-glyphics.css">
    <link rel="stylesheet" href="stylesheets/colorsheets-default.css">
    <link rel="stylesheet" href="stylesheets/colorsheets-viewport.css">
    ...
    <script type="text/javascript" src="scripts/grasppe-prototypes.js"></script>
    <script type="text/javascript" src="scripts/grasppe-canvas.js"></script>
    <script type="text/javascript" src="scripts/grasppe-geometry.js"></script>
    <script type="text/javascript" src="scripts/grasppe-gapi.js"></script>
    <script type="text/javascript" src="scripts/colorsheets-jiver.js"></script>
    <script type="text/javascript">
        var app = {},
            definitions, parameters, model, googleAPI;
                ...
                authorized: function (event, target) {
                    ...
                    target.run('SuperCellScreenGetModel', [], function (request) {
                        if ('result' in request && 'response' in request.result) {
                            ...
                            model = app.model;
                            app.parameters = model.parameters, parameters = app.parameters
  ...
  <body style="background: #ED4F43 URL(images/Grasppe-ColorSheets-Icon-256.png) no-repeat center center;  min-height: 100vh;">
    ...
    <div class="panel panel-default" id="page-panel">
      <div class="panel-heading">
        <div class=" pull-right">
            <span class="" id="authorize-div">&nbsp;</span>
            <a class="btn btn-xs btn-info " style="margin-left: 4px;" role="button" data-toggle="collapse" href="#app-intro-collapse" aria-expanded="false" aria-controls="app-intro-collapse"><i class="glyphicon glyphicon-info-sign" style="color:#fff"></i></a>
            <a class="btn btn-xs btn-success " style="margin-left: 4px;" role="button" data-toggle="modal" data-target="#paper-modal" href="#paper-modal"><i class="glyphicon glyphicon-education" style="color:#fff"></i></a>
        </div>
        <h3 class="panel-title" id="main-heading">SuperCell Screening Calculator Demo</h3>
        <!-i class="fa fontelico-spin6 fa-pulse"></i-->
      </div>
      ...
      <div class="container-fluid">
        <div class="row" style="margin-top: 0">
            <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 container-fluid" id="main-stage" style="margin-top: 10px; min-height: 250px;">
              <div style="display: flex; flex-direction:column; width: 100%; height: 100%; flex: 1;">
                <div id="stage-wrapper" class="col-xs-12 col-sm-12 col-md-12 col-lg-12 well-sm" style="display: flex; width: 100%; flex: 1; padding-top: 0;">
                  <div id="stage-canvas-wrapper" style="vertical-align: middle; flex: 1; text-align: center; width:100%;">
                    <div id="stage-canvas" style="display: block; margin: auto; width: 400px; height: 400px; text-align: center; overflow: hidden; padding: 1em;">
                    </div>
                  </div>
                </div> <!-- stage-wrapper -->
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 well-sm" id="parameters-wrapper" style="flex: 1;">
      ...
      <div class="panel-footer well-sm" id="page-footer"><small class="text-muted">Copyright &copy; 2015, Franz Sigg and Saleh Abdel Motaal.</small></div>
    </div> <!-- panel panel-default -->
    <div class="modal fade" id="paper-modal" tabindex="-1" role="dialog">
      <div class="modal-dialog" role="document" style= "max-width: 90%; min-height: 90vh; width: 100em;">
        <div class="modal-content" style="border-radius: 0;">
          <div id="paper-modal-body" class="modal-header">
              <div class="row">
                <button type="button" class="close btn btn-xs pull-right" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <header style="margin: 0 2em;">
          ...
          <div id="paper-modal-body" class="modal-body" style="max-width: 100%; min-width: 100%; min-height: 85vh;"> <!--data-spy="scroll" data-target="#myScrollspy" data-offset="0" -->
            <div class="container col-sm-12">
              <div class="row">
                <div class="hidden-xs col-sm-3 col-lg-2 pull-right" id="myScrollspy">
                ...
                <div class="col-xs-12 col-sm-9 col-lg-10 container-fluid well-sm" style="max-height: 75vh; overflow-y: scroll;" id="paperScrollContainer">
